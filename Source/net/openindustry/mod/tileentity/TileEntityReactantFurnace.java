package net.openindustry.mod.tileentity;
...
public class TileEntityReactantFurnace extends TileEntity implements
		ISidedInventory {
	...
	private static int getItemBurnTime(ItemStack itemstack) {
		if (itemstack == null) {
			...
			if (item == OpenIndustry.itemReactiveCluster)
				return 75 * 2;
			if (item == OpenIndustry.itemReactiveIngot)
				return 75 * 8;
		}
		return 0;
	}
	...
	public void updateEntity() {
		...
		if (!this.worldObj.isRemote) {
			...
			if (flag != this.isBurning()) {
				flag1 = true;
				ReactantFurnace.updateReactantFurnaceBlockState(
